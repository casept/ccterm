# Taken from
# https://github.com/diasurgical/devilutionX/blob/master/CMake/FindSDL2_ttf.cmake,
# commit 4e1b35b71e2a70fcc22ebcfaf9da9d41ca8dec70
#
# * Find SDL2_ttf Find the SDL2 headers and libraries
#
# SDL2::SDL2_ttf - Imported target
#
# SDL2_ttf_FOUND - True if SDL2_ttf was found. SDL2_ttf_DYNAMIC - If we found a
# DLL version of SDL2_ttf
#
# Modified for SDL2_ttf of FindSDL2.cmake Original Author: 2015 Ryan Pavlik
...
find_library(
  ...
  PATHS ${SDL2_ttf_ROOT_DIR} ENV SDL2DIR
  ...
  if(NOT TARGET SDL2::SDL2_ttf)
    ...
    if(WIN32 AND SDL2_ttf_RUNTIME_LIBRARY)
      ...
      if(SDL2_ttf_FRAMEWORK AND SDL2_ttf_FRAMEWORK_NAME)
        # Handle the case that SDL2_ttf is a framework and we were able to
        # decompose it above.
        set_target_properties(
          SDL2::SDL2_ttf
          PROPERTIES IMPORTED_LOCATION
                     "${SDL2_ttf_FRAMEWORK}/${SDL2_ttf_FRAMEWORK_NAME}")
      elseif(_sdl2_framework AND SDL2_ttf_LIBRARY MATCHES
                                 "(/[^/]+)*.framework$")
        # Handle the case that SDL2_ttf is a framework and SDL_LIBRARY is just
